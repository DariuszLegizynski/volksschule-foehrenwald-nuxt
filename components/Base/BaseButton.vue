...
<template>
	...
	>
		<div class="border-2 border-primary py-2 px-2 text-white bg-primary rounded-lg uppercase font-bold tracking-wider transform translate-x-1 -translate-y-1">
			<slot></slot>
		</div>
	</NuxtLink>
	<NuxtLink
	...
	>
		<div class="border-2 border-white py-2 px-2 text-primary bg-white rounded-lg uppercase font-bold tracking-wider transform translate-x-1 -translate-y-1">
			<slot></slot>
		</div>
	</NuxtLink>
