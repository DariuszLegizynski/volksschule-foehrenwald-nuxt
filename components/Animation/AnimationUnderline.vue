<script setup lang="ts">
	...
	onMounted(() => {
		...
		gsap.fromTo(
			iconPath.value,
			{ strokeDashoffset: iconPathlength, fill: "transparent" },
			{
				strokeDashoffset: 0,
				duration: 2,
				scrollTrigger: {
